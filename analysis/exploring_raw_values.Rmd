...
pander(corvif(df[,c('lon','aspect50mean_deg_group','slope50mean_deg')]))
detach(package:pander, unload=TRUE)
```


```{r, echo=FALSE, fig.cap=fig$cap("ggpair_scod", "Explore relationships of covariates (Snow cover onset dates"), fig.height=12 , fig.width=11}
