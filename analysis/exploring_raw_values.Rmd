...
x <- corvif(df[,c('lon','aspect50mean_deg_group','slope50mean_deg')])
pander(x)
```

```{r, fig.cap=fig$cap("ggpair_scod", "Explore relationships of covariates (Snow cover onset dates"), fig.height=8 , fig.width=11}
