...
a <- ggplot(scd, aes(x=dem50mean, y=mean)) + 
  geom_point() +  
  mythemeggplot + 
...
ggplot(scd, aes(x=dem50mean, y=mean)) + geom_point()
```
...
exportpdf(mypdf=paste0(di, '/images/raster_maps/r_mean_scd_1900.pdf'), lp) 
...
print(lp)
exportpdf(mypdf=paste0(di, '/images/raster_maps/r_cv_scd_1900.pdf'), lp) 
...
print(lp)
exportpdf(mypdf=paste0(di, '/images/raster_maps/r_mean_scod_1900_non_isolines.pdf'), lp) 
...
print(lp)
exportpdf(mypdf=paste0(di, '/images/raster_maps/r_cv_scod_1900.pdf'), lp) 
...
print(lp)
exportpdf(mypdf=paste0(di, '/images/raster_maps/r_mean_scmd_1900.pdf'), lp) 
...
print(lp)
exportpdf(mypdf=paste0(di, '/images/raster_maps/r_mean_scmd_1900_non_isolines.pdf'), lp) 
```
...
print(lp)
exportpdf(mypdf=paste0(di, '/images/raster_maps/r_cv_scmd_1900.pdf'), lp) 
...
print(lp)
exportpdf(mypdf=paste0(di, '/images/raster_maps/r_mean_scmc_1900.pdf'), lp) 
...
print(lp)
exportpdf(mypdf=paste0(di, '/images/raster_maps/r_mean_scmc_1900_non_isolines.pdf'), lp) 
...
print(lp)
exportpdf(mypdf=paste0(di, '/images/raster_maps/r_cv_scmc_1900.pdf'), lp) 
...
# Subset data and classify elevation 
scd1900 <- scd %>% filter(dem50mean > 1900) %>%
  mutate(dem50mean_group = cut(dem50mean, 
                         breaks = seq(from=0, to=3500, by=250),
                         labels = c("0-250", "251-500","501-750","751-1000",
