...
A total of `r ((fulldf1900 %>% filter(tau_scod > 0) %>% filter(tau_scmd < 0) %>% count()) / fulldf1900 %>% count())*100` pixels (of all above 1900) showed a positive trend in snow cover onset date (late onset) and a negative trend in snow cover melting date (earlier melting date). 
